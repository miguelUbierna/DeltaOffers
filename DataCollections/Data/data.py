...
delete = "DELETE FROM convocatorias"
...
for fila in scraperUBU.ubu_general:
    if fila[4] == 'No especificada' and fila[5] == 'No especificada':
        ...
        insert = "INSERT INTO convocatorias (titulo, plazo, enlace, descripcion,fecha_public,fecha_ini,fecha_fin,convocante,destinatarios,categoria,universidad,imagen_logo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
...
for fila in scraperULE.ule_general:
    ...
    insert = "INSERT INTO convocatorias (titulo, enlace,fecha_public,categoria,tipo,fecha_ini,fecha_fin,plazo,nombre_plaza,convocatoria_asociada,descripcion,universidad,imagen_logo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
...
for fila in scraperPDI.uva_general:
    if fila[1] == 'No especificado' and fila[2] == 'No especificado':
        ...
        insert = "INSERT INTO convocatorias (titulo, fecha_ini, fecha_fin, plazo,enlace,clasificacion,tipo,universidad,categoria,imagen_logo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
