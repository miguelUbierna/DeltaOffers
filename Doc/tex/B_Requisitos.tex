...
\begin{itemize}
\item\textbf{RF-4.3.1 Compatibilidad ICalendar con principales servicios de calendario}: La aplicación debe proporcionar un archivo de extension ".ics" que debe de ser compatible con Outlook, Google Calendar y otros.
\end{itemize}
